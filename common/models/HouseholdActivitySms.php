 ...
 */
class HouseholdActivitySms extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['activity_id', 'user_id', 'status', 'updated_UID'], 'integer'],
