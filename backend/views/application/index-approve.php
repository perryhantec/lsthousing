...
<div class="users-index">
  <p>
      <?= Html::a(Yii::t('app', 'Export'), ['export'], ['class' => 'btn btn-success popupModal']) ?>
  </p>

    <?php Pjax::begin(['id'=>'application-approve-pjax']); ?>
  ...
  //                  return Yii::$app->formatter->asDate($model->created_at, 'long');
        ...
        [
          'attribute' => 'approved',
          'vAlign'=>'middle',
          'filter' => Definitions::getApproved(),
          'value' => function($model){
      ...
      [
        ...
        'template'=> '{view} {update} {update-approve}',
        ...
        'buttons' => [
          ...
          'update-approve' => function ($url, $model, $key) {
            return  Html::a('更新批核狀態', $url, ['class' => 'btn btn-primary btn-xs']);
          },
        ],
        'visibleButtons' => [
