...
<?php } ?>
    ...
    <?php Pjax::begin(['id'=>'application-allocate-pjax']); ?>
  ...
  //                  return Yii::$app->formatter->asDate($model->created_at, 'long');
        ...
        [
          ...
          'value' => function($model){
                    return Definitions::getProjectName($model->project);
          },
          'headerOptions'=>['class'=>'kv-sticky-column'],
          'contentOptions'=>['class'=>'kv-sticky-column', 'style'=>'width: 10%;'],
        ],
      ...
      [
        ...
        'template'=> '{view} {update} {update-allocate}',
        ...
        'buttons' => [
          ...
          'update-allocate' => function ($url, $model, $key) {
            return  Html::a('更新編配單位', $url, ['class' => 'btn btn-primary btn-xs']);
          },
        ],
        'visibleButtons' => [
