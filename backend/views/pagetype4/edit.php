...
$this->registerJs(<<<JS
    ...
    $('.pagetype4-picture_file_names-remove')
        .click(function() {
    ...
    //            'startDate' => date('Y-m-d'),
        ...
        <div class="pt4-top_media_type-detail pt4-top_media_type-detail-<?= $model::TMT_IMAGE ?>"<?= $model->top_media_type != $model::TMT_IMAGE ? ' style="display:none"' : '' ?>>
            ...
            <div class="form-group field-pagetype4-image_file_name">
                <label class="control-label" for="pagetype4-image_file_name"><?= Yii::t('app', 'Thumbnail') ?></label>
...
<?php if ($model::CROP_IMAGE_FILE) { ?>
            <span class="field-pagetype4-image_file"<?= ($model->image_file_name != "" ? ' style="display: none;"' : '') ?>>(<?= Yii::t('app', 'Please remember to click \'Crop\'');?>)</span>
            <?=
...
<?php } ?>
        ...
        <div class="form-group">
            <label class="control-label" for="pagetype4-upload_files"><?= Yii::t('app', 'Images') ?></label>
        </div>
