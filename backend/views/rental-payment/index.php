...
$user_model = User::findOne(['id' => $uid]);

$this->title = '住戶上載交租文件 ('.$user_model->chi_name.')';
$this->params['breadcrumbs'][] = ['label' => '住戶上載交租文件 (請先選擇用戶)', 'url' => ['/user/rental-payment-list']];
...
<?php if (false) { ?>
    <p>
      <?= Html::a(Yii::t('app',"Create {modelClass}",['modelClass'=>'要求上載文件']),['create', 'aid' => $user_model->id],
            ['class' => 'btn btn-success']);
                  ?>
    </p>
<?php } ?>
    <?php Pjax::begin(['id'=>'rental-payment-pjax']); ?>
