            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <?=  Html::a('評分詳細', ['application-mark/update', 'id' => $model->applicationMark->id], ['class' => 'btn btn-sm btn-primary pull-right','style'=>'margin-right:5px;']) ?>
                    </div>
                </div>
                <div class="box-body">
                    <?= DetailView::widget([
                        ...
                        'attributes' => [
                            ...
                            [
                                ...
                                'value' => function($model) { return $model->applicationMark->total; },
                            ],
                        ],
                    ]) ?>
                </div>
                    ...
                    <?= DetailView::widget([
                        ...
                        'attributes' => [
                            ...
                            [
                                ...
                                'value' => function($model) { return $model->app_funding_type ? Definitions::getFundingType($model->app_funding_type) : '-'; }
                            ],
                            [
                        ...
                        <?= DetailView::widget([
                            ...
                            'attributes' => [
                                ...
                                [
                                    ...
                                    'value' => function($model) { return $model->m1_funding_type ? Definitions::getFundingType($model->m1_funding_type) : '-'; }
                                ],
                                [
                        ...
                        <?= DetailView::widget([
                            ...
                            'attributes' => [
                                ...
                                [
                                    ...
                                    'value' => function($model) { return $model->m2_funding_type ? Definitions::getFundingType($model->m2_funding_type) : '-'; }
                                ],
                                [
                        ...
                        <?= DetailView::widget([
                            ...
                            'attributes' => [
                                ...
                                [
                                    ...
                                    'value' => function($model) { return $model->m3_funding_type ? Definitions::getFundingType($model->m3_funding_type) : '-'; }
                                ],
                                [
                        ...
                        <?= DetailView::widget([
                            ...
                            'attributes' => [
                                ...
                                [
                                    ...
                                    'value' => function($model) { return $model->m4_funding_type ? Definitions::getFundingType($model->m4_funding_type) : '-'; }
                                ],
                                [
                        ...
                        <?= DetailView::widget([
                            ...
                            'attributes' => [
                                ...
                                [
                                    ...
                                    'value' => function($model) { return $model->m5_funding_type ? Definitions::getFundingType($model->m5_funding_type) : '-'; }
                                ],
                                [
