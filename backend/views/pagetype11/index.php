...
<p>
      <?= Html::a(Yii::t('app',"Create {modelClass}",['modelClass'=>'樂屋新項目']),['create'],
            ['class' => 'btn btn-success']);
                  ?>
</p>

<?php Pjax::begin(['id'=>'pagetype11-pjax']); ?>
...
[
    ...
    [
      ...
      'editableOptions'=> ['formOptions' => ['action' => ['pagetype11/edit_grid']]]
