...
<p>
      <?= Html::a(Yii::t('app',"Create {modelClass}",['modelClass'=>'樂屋新建案']),['create'],
...
*/
    ...
    */
    [
      'attribute' => 'is_open',
      'vAlign'=>'middle',
      'filter' => Definitions::getIsOpen(),
      'value' => function($model){
          return Definitions::getIsOpen($model->is_open);
      },
      'width' => '10%',
      'headerOptions'=>['class'=>'kv-sticky-column'],
      'contentOptions'=>['class'=>'kv-sticky-column'],
    ...
    [
      ...
      'template'=>'{update} {open} {close} {enabled} {disabled} {delete}',
      'width' => '10%',
      'headerOptions'=>['style'=>'width: 10%;'],
    'buttons' => [
        'open' => function ($url, $model, $key) {
          return Html::a('開放申請', $url, ['class' => 'btn btn-xs btn-info']);
        },
        'close' => function ($url, $model, $key) {
          return Html::a('暫停申請', $url, ['class' => 'btn btn-xs btn-danger']);
        },
    ],
...
*/
        'visibleButtons' => [
            'open' => function ($model) { return $model->is_open == -1; },
            'close' => function ($model) { return $model->is_open == 1; },
