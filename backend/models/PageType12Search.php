...
class PageType12Search extends PageType12
{
    ...
    public function rules()
    {
        return [
            ...
            // [['id', 'MID', 'district_id', 'avl_no_of_people_min', 'avl_no_of_people_max', 'avl_no_of_application', 'avl_no_of_live_year', 'is_open', 'status', 'updated_UID'], 'integer'],
            [['id', 'is_open', 'status'], 'integer'],
            // [['title_tw', 'title_cn', 'title_en', 'created_at', 'updated_at'], 'safe'],
            [['title_tw', 'display_at'], 'safe'],
        ];
    }
...
/*
        $query->andWhere(['or',
                ...
                ['like', 'content_tw', "<a"]]);
*/
$query->andFilterWhere(['like', 'title_tw', $this->title]);
