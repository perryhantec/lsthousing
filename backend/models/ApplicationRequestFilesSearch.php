 ...
 */
class ApplicationRequestFilesSearch extends ApplicationRequestFiles
{
    public $date;
    public $date2;
    public $chi_name;
    ...
    public function search($params, $id = false)
    {
        if (!$id) {
            ...
            $query = ApplicationRequestFiles::find()->where(['application_id' => $id]);
            // $query = ApplicationRequestFiles::find();
        }
        ...
        $dataProvider->sort->attributes['date'] = [
            'asc' => ['application_request_files.created_at' => SORT_ASC],
            'desc' => ['application_request_files.created_at' => SORT_DESC],
            'default' => SORT_DESC,
            'label' => Yii::t('app', 'Date'),
        ];
        $dataProvider->sort->attributes['date2'] = [
            'asc' => ['application_request_files.updated_at' => SORT_ASC],
            'desc' => ['application_request_files.updated_at' => SORT_DESC],
            'default' => SORT_DESC,
        ...
        $query->andFilterWhere(['=', new Expression('DATE(application_request_files.created_at)'), $this->date]);
        $query->andFilterWhere(['=', new Expression('DATE(application_request_files.updated_at)'), $this->date2]);
