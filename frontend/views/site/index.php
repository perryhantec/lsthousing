...
?>
<style>
.page-top_youtube:after{content:'';display:table;clear:both;}
.youtube-list{height:470px;overflow-y:scroll;}

@media (max-width:1200px){
  .youtube-list{height:385px;}
}
@media (max-width:992px){
  .youtube-list{height:293px;}
}
@media (max-width:768px){
  .youtube-list{height:auto;overflow-y:visible;}
}
</style>
...
<?php if (sizeof($model_home->top_youtubes) > 0) { ?>
    <div class="page-top_youtube">
        <div class="col-sm-9">
          <div class="row">
            <div class="youtube-box" style="padding-top:57%;">
                <?= Html::tag('iframe', '', [
